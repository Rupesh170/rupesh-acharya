...
const featuredProjects = [
  {
    ...
    description: 'High-fidelity 3D replica of a city district built from LiDAR, drone imagery, and cadastral data.',
    problem: 'City planners needed a real-time navigable model of downtown infrastructure for smart city planning.',
    tools: ['LiDAR', 'Photogrammetry', 'CityGML', 'Unity 3D', 'ArcGIS'],
  ...
  },
  {
    ...
    description: 'Centimeter-accurate terrain model generated from multi-flight drone survey campaigns.',
    problem: 'Mining engineers required precise volumetric data across a 200-hectare site.',
    tools: ['Drone Survey', 'Agisoft Metashape', 'QGIS', 'ArcGIS Pro', 'DEM'],
  ...
  },
  {
    ...
    description: 'Automated pipeline converting total station survey data into production-ready CAD drawings.',
    problem: 'Construction firms lost weeks converting field survey data into usable CAD deliverables.',
    tools: ['Total Station', 'AutoCAD', 'Civil 3D', 'Python', 'QGIS'],
    ...
    <div>
      ...
      <section className="relative min-h-screen flex flex-col" style={{ backgroundColor: '#0a0a0a' }}>
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(to bottom, rgba(0,0,0,0.65) 0%, rgba(0,0,0,0.45) 60%, rgba(10,10,10,1) 100%)',
          }}
        />
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center max-w-[1440px] mx-auto w-full px-fluid-md py-fluid-2xl">
          <div className="max-w-[800px]">
            ...
            <PDisplay
              size={{ base: 'small', m: 'medium', l: 'large' }}
              theme="dark"
              tag="h1"
              align="start"
            >
            ...
            >
              I create highly accurate 2D maps, 3D digital replicas, Digital Twins, and CAD outputs
              ...
              >
                ...
                <div className="p-fluid-md flex flex-col flex-1">
                  ...
                  <div className="mb-fluid-sm">
                    <PText size="x-small" weight="semi-bold" tag="p" className="mb-static-xs">Problem:</PText>
                    <PText size="x-small" color="contrast-medium" tag="p">{project.problem}</PText>
                  </div>
